...
import { boardAddSchema, boardEditSchema } from "../validation/boards";
...
boardsRouter.put("/:boardId", isValidId("boardId"), validateBody(boardEditSchema), ctrlWrapper(boardsControllers.updateBoardController))
